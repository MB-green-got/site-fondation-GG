...
const statiques = [
  ...
  { url: '/soutiens-passes', modifieLe: '2026-09-18', titre: 'Soutiens passés', description: "Les associations que la Fondation Green-Got a soutenues et qui n'ont plus de projet en cours, avec le montant versé à chacune et les années." },
